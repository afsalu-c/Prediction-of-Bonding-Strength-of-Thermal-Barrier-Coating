...
# Grid Search
grid_search = GridSearchCV(xgbr, param_grid, cv=5, scoring='neg_root_mean_squared_error', verbose=1, n_jobs=-1)
...
def predict_bonding_strength_Xg(thickness, current, voltage, power, ar, h2, ar_h2):
